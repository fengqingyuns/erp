 ...
 */
@Service
public class PurchaseStockInServiceImpl2 implements PurchaseStockInService {

    private static final Logger LOGGER = LoggerFactory.getLogger(PurchaseStockInServiceImpl2.class);
                ...
                for (PurchaseOrderDetail purchaseOrderDetail : purchaseOrderDetailList) {
                    ...
                    if (stockPickingGoodsMap.get(purchaseOrderDetail.getGoodsId()) != null) {
                        ...
                        Long stockInAmount = pickingAmount > remainingAmount ?
                                ...
                                //来源采购的入库数量  即:页面传来的入库数        =    入库数 -         db入库数  
